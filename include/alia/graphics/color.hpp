#ifndef COLOR_F764AC12_3B95_48B6_8843_C95E45B7DD74
#define COLOR_F764AC12_3B95_48B6_8843_C95E45B7DD74
...
namespace alia {
    ...
    struct color {
        ...
        static constexpr color of(uint8_t r, uint8_t g, uint8_t b) { return {r / 255.f, g / 255.f, b / 255.f, 1.0}; }

        static constexpr color of(uint8_t r, uint8_t g, uint8_t b, uint8_t a) { return {r / 255.f, g / 255.f, b / 255.f, 1.0}; }

        static constexpr color of(vec3f c) { return {c[0], c[1], c[2], 1.0f}; }

        static constexpr color of(vec4f c) { return {c[0], c[1], c[2], c[3]}; }
        ...
        static constexpr color cga(int index) {
            switch (index) {
            case 0:
                return of_rgb24(0x000000);
            case 1:
                return of_rgb24(0x0000AA);
            case 2:
                return of_rgb24(0x00AA00);
            case 3:
                return of_rgb24(0x00AAAA);
            case 4:
                return of_rgb24(0xAA0000);
            case 5:
                return of_rgb24(0xAA00AA);
            case 6:
                return of_rgb24(0xAA5500);
            case 7:
                return of_rgb24(0xAAAAAA);
            case 8:
                return of_rgb24(0x555555);
            case 9:
                return of_rgb24(0x5555FF);
            case 10:
                return of_rgb24(0x55FF55);
            case 11:
                return of_rgb24(0x55FFFF);
            case 12:
                return of_rgb24(0xFF5555);
            case 13:
                return of_rgb24(0xFF55FF);
            case 14:
                return of_rgb24(0xFFFF55);
            case 15:
                return of_rgb24(0xFFFFFF);
            default:
                return of_rgb24(0x000000);
            };
        }
...
#endif /* COLOR_F764AC12_3B95_48B6_8843_C95E45B7DD74 */
